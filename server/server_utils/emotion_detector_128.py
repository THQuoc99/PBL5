...
from AI_models.resnet.models.resnet50_128x128 import ResNet50Plus
...
class EmotionDetector:
    ...
    def init_yolo(self):
        ...
        checkpoint_path = ROOT_DIR / 'AI_models' / "weights" / "yolo" / "yolov5m_epoch_44_loss_0.2633.pt"
    ...
    def init_resnet(self):
        ...
        checkpoint_path = ROOT_DIR / 'AI_models' / "weights" / "resnet" / "resnet-50-128x128.pth"
        checkpoint = torch.load(str(checkpoint_path), map_location=device)
