...
from resnet.models.resnet50 import ResNet50Plus
...
def init_yolo():
    ...
    checkpoint_path = ROOT_DIR / "weights" / "yolo" / "yolov5m_epoch_36_loss_0.2693.pt"
...
def init_resnet():
    ...
    checkpoint_path = ROOT_DIR / "weights" / "resnet" / "resnet50_weights_20epoch.pth"
    checkpoint = torch.load(str(checkpoint_path), map_location=device)
